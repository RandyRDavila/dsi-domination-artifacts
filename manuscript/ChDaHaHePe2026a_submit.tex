...
are included in \path{computational_data/ensemble/}. The script
...
files, CBC logs, solution files, and metadata are included in
\path{computational_data/real_data/}. The script
