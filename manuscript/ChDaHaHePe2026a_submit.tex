...
\newcommand{\ArtifactEnsembleDir}{\url{https://github.com/RandyRDavila/dsi-domination-artifacts/tree/main/computational_data/ensemble}}
\newcommand{\ArtifactRealDataDir}{\url{https://github.com/RandyRDavila/dsi-domination-artifacts/tree/main/computational_data/real_data}}
...
are available in the artifact repository at \ArtifactEnsembleDir. The
...
repository at \ArtifactRealDataDir. The regeneration script is available at
\path{computational_data/real_data_dsi_experiment.py} and uses only the
Python standard library and the command-line CBC solver.
